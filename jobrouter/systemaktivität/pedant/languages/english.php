...
define('IMPORTVENDORCSV_DESC', 'This systemactivity can be used to add a database of vendors.');
define('IMPORTVENDORCSV', 'Import Vendor');
define('IMPORTRECIPIENTCSV', 'Import Recipient');
define('IMPORTRECIPIENTCSV_DESC', 'This systemactivity can be used to add a database of recipients.');
...
define('IMPORTVENDOR', 'Vendorconfiguration');
...
define('IMPORTRECIPIENT', 'Recipientconfiguration');
define('RECIPIENTTABLE', 'Recipienttable');
define('SORTCODE', 'Sortcode');
define('IMPORTCOSTCENTERCSV', 'Import Cost Center');
